...
import { SetCompany } from './contracts/methods'
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4">
      ...
      <Card className="w-full max-w-md bg-gray-800 text-gray-100">
        <CardHeader>
          <CardTitle className="text-white">Company SignUp & Credit Update</CardTitle>
          <CardDescription className="text-gray-400">Connect your wallet and update your company credits</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="updateCredits" className="text-gray-200">Update Credits</Label>
                <Input
                  id="updateCredits"
                  name="updateCredits"
                  type="number"
        ...
        <CardFooter>
          <Button
            ...
            // disabled={!isConnected} 
            onClick={() => SetCompany(formData.companyName, Number(formData.updateCredits))}
          >
            Sign Up
          </Button>
        </CardFooter>
