...
import { BuyCredit, ExchangeCredit, SellCredit, SetCompany, ShowCredit, vault } from '../contracts/methods'
    ...
    <div className="min-h-screen bg-gray-900 flex items-center justify-center p-4">
      ...
      <Card className="w-full max-w-md bg-gray-800 text-gray-100">
        <CardHeader>
          ...
          <CardDescription className="text-gray-400">Buy Credits from Vault</CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <CardFooter>
          <Button 
            ...
            // disabled={credits<=0} 
            onClick={()=>BuyCredit(Number(formData.updateCredits))}
          >
          Buy
          </Button>
        </CardFooter>
